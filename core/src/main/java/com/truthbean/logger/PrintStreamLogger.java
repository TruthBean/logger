 ...
 * @since 0.6.2
 */
public class PrintStreamLogger implements ConfigurableLogger {
    ...
    private final PrintStream exPrintScream;

    public PrintStreamLogger(PrintStream printStream, PrintStream exPrintScream) {
        this.printStream = printStream;
        this.exPrintScream = exPrintScream;
    }
    ...
    public boolean isLoggable(LogLevel level) {
        return this.level != LogLevel.OFF && level != LogLevel.OFF &&
    ...
    public void logging(LogLevel level, Throwable ex, String message, Object... params) {
        ...
        if (ex != null) {
            ex.printStackTrace(exPrintScream);
        }
    }
}
